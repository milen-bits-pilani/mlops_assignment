...
def train_models(data_path: str, output_dir: str = "models", mlflow_experiment: str = "heart_disease"):
    """
    ...
    # Use current working directory or project root, whichever is more reliable
    # In CI/CD, use current working directory to ensure writable location
    cwd = os.getcwd()
    ...
    mlflow_tracking_uri = os.path.abspath(mlruns_dir)
